...
However, when searched specifically against tardigrade sequences, it produced a significant hit with [P0DOW4.1](https://www.ncbi.nlm.nih.gov/protein/P0DOW4.1?report=genbank&log$=prottop&blast_rank=1&RID=Z89UZCH9016 "Show report for P0DOW4.1")  (**e-value of 0**). This supports our hypothesis that it is a tardigrade-specific protein. Given these findings and supporting literature identifying **g14472.t1** as peptide from a tardigrade protein - recommended for experimental validation as potential DNA-binding proteins.[[Genomic-data-analysis/Project_4_Tardigrades/Report#Refernces| [1] ]]
